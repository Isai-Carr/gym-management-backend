...
export class MembershipsController {
  ...
  @Roles(Role.ADMIN)
  @ApiOperation({ summary: 'Switch a membership to a different plan, starting a fresh billing period (Admin)' })
  changePlan(@Param('id') id: string, @Body() dto: ChangeMembershipPlanDto) {
